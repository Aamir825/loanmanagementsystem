...
const Home = () => {
  return (
    <div className=' grid grid-cols-4 gap-2'>
      <div className=' bg-white bg-opacity-5 p-4 rounded-lg text-white flex gap-3'>
        <div>
          <AiOutlineProduct className=' bg-gradient-to-r from-[#000000] to-[#1a2b2e] p-1 rounded-md' size={32} />
        </div>
        <div>
          <h1 className='mb-3 text-[14px]'>Total Products</h1>
      ...
      <div className=' bg-white bg-opacity-5 p-4 rounded-lg text-white flex gap-3'>
        <div>
          <SiAlwaysdata className=' bg-gradient-to-r from-[#000000] to-[#1a2b2e] p-1 rounded-md' size={32} />
        </div>
        <div>
      ...
      <div className=' bg-white bg-opacity-5 p-4 rounded-lg text-white flex gap-3'>
        <div>
          <SiTraefikproxy className=' bg-gradient-to-r from-[#000000] to-[#1a2b2e] p-1 rounded-md' size={32} />
        </div>
        <div>
      ...
      <div className=' bg-white bg-opacity-5 p-4 rounded-lg text-white col-span-1 row-span-3'>
        <p className=" bg-gradient-to-r from-[#000000] to-[#1a2b2e] inline-block py-1 px-2 text-[11px] mb-4 text-[#ff3300] rounded-lg">
          Team Review
        </p>
      ...
      <div className=' bg-white bg-opacity-5 p-4 rounded-lg text-white col-span-3 row-span-4'>
        <Chart/>
      </div>
    </div>
  )
